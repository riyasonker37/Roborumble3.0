...
export default function AdminDashboard() {
    ...
    return (
        <main className="min-h-screen bg-transparent text-white p-4 md:p-8 font-mono relative">
                                ...
                                <tr key={u.id} className="border-b border-zinc-800 hover:bg-zinc-900/50 transition-colors">
                                    ...
                                    <td className="p-4 text-right">
                                        <button
                                            ...
                                            className={`px-3 py-1 font-bold tracking-wider transition-all border ${u.paymentStatus === 'paid'
